...
export function getAppElements() {
  return {
    ...
    historyUp: requireElement<HTMLButtonElement>('history-up'),
    historyDown: requireElement<HTMLButtonElement>('history-down'),
    historySuggestions: requireElement<HTMLDivElement>('history-suggestions'),
